...
PONEPAINTCOL EQU 242 ;Player One Paint Col
PTWOPAINTCOL EQU 252 ;Player Two Paint Col
TIMERCOL EQU 0F9h
GAMETIME EQU 100

timerPos dw  3040                
pOnePos dw 1680 ;Player One Initial Pos (centre)
pTwoPos dw 1670 ;Player Two Initial Pos (centre)
